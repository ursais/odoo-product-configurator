...
class ProductTemplate(models.Model):
    ...
    @api.multi
    def create_get_variant(self, value_ids, custom_values=None, website_values={}):
        ...
        for attribute_value in variant.attribute_value_ids:
            product_qty = wizard_values and int(wizard_values.get(attribute_value.id,1)) or 1
            line_vals.append((0, 0, {'product_id': attribute_value.product_id.id,
